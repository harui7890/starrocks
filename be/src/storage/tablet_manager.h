...
public:
    ...
    TabletSharedPtr get_tablet(TTabletId tablet_id, bool include_deleted = false, std::string* err = nullptr,int64_t staros_shardid=0);

    TabletSharedPtr get_tablet(TTabletId tablet_id, const TabletUid& tablet_uid, bool include_deleted = false,std::string* err = nullptr,int64_t staros_shardid=0);
